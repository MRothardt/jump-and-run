...
public class GamePanel extends JPanel {
    ...
    private static final int LAVA_TOD_ANIMATION_DAUER = 34;
    private static final int STEIN_TOD_ANIMATION_DAUER = 24;
    ...
    private double sterbeFortschritt() {
        ...
        return 1.0 - Math.pow(1.0 - linearerFortschritt, 3.0);
    }
    ...
    private void gameOverZeichnen(Graphics g) {
        ...
        zentriertenTextZeichnen(g, gameOverText(), 240);
    ...
    private String gameOverText() {
        if (todesUrsache == TodesUrsache.FALLENDER_STEIN) {
            return "Du wurdest vom Stein erschlagen";
        }

        return "Du bist in die Lava gefallen";
    }
